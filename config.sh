...
ifeq (\$(BUILDTYPE),Debug)
    ...
    CXXFLAGS += $DEBUG_CXXFLAGS -D_DEBUG
    ASFLAGS += $DEBUG_ASFLAGS -D_DEBUG
    LDFLAGS += $DEBUG_LDFLAGS
else ifeq (\$(BUILDTYPE),Release)
    CFLAGS += $RELEASE_CFLAGS -DNDEBUG
    CXXFLAGS += $RELEASE_CXXFLAGS -DNDEBUG
    ASFLAGS += $RELEASE_ASFLAGS -DNDEBUG
    LDFLAGS += $RELEASE_LDFLAGS
else ifeq (\$(BUILDTYPE),Profile)
    CFLAGS += $PROFILE_CFLAGS -DNDEBUG -D_PROFILE
    CXXFLAGS += $PROFILE_CXXFLAGS -DNDEBUG -D_PROFILE
    ASFLAGS += $PROFILE_ASFLAGS -DNDEBUG -D_PROFILE
